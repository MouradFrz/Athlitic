   ...
   <div class="wrapper">
    ...
    <div class="sidebar">
        ...
        <div class="navigation">
            <ul>
                <li><a href="" class=""><i class="bi bi-speedometer"></i><span >Dashboard</span></a></li>
                <li><a href="" class=""><i class="bi bi-shop"></i><span>Products Management</span></a></li>
                <li><a href="" class=""><i class="bi bi-collection"></i><span>Collection Management</span></a></li>
        ...
        <div class="logout">
            <ul>
                <li><button class="custom-button sidebar-toggler"><i class="bi bi-arrow-right-square"></i></button></li>
                <li><a href="{{ route('user.logout') }}"><i class="bi bi-box-arrow-right"></i><span>Logout</span></a></li>
            </ul>
        </div>
    </div>
